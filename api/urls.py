...
from .gerenciamento_views import (
    ...
    alterar_status_movimento, alterar_status_parcela,
    criar_pessoa, criar_classificacao
)
...
urlpatterns = [
    ...
    path('gerenciar/pessoas/criar/', criar_pessoa, name='criar_pessoa'),
    ...
    path('gerenciar/classificacoes/criar/', criar_classificacao, name='criar_classificacao'),
    ...
    path('gerenciar/movimentos/<int:movimento_id>/status/', alterar_status_movimento, name='alterar_status_movimento'),
    ...
    path('gerenciar/parcelas/<int:parcela_id>/status/', alterar_status_parcela, name='alterar_status_parcela'),
