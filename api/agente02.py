...
def registrar_movimento(fornecedor_id, faturado_id, classificacao_id, dados_nf):
    ...
    try:
        ...
        try:
            ...
            classificacao = Classificacao.objects.get(id=classificacao_id, ativo=True)
        ...
        itens = dados_nf.get('produtos') or []
        movimento.itens_json = itens if isinstance(itens, list) else []
        movimento.save()
